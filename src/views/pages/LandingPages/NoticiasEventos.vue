...
<template>
    <div v-if="noticias" id="noticias-recientes" class="relative flex flex-col items-center text-center px-3 lg:px-2 py-12 bg-gray-100">
        <div class="w-full lg:w-3/4">
            ...
            <div v-for="(noticia, index) in noticias" :key="index" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="relative bg-white p-6 rounded-lg shadow-lg overflow-hidden group">
